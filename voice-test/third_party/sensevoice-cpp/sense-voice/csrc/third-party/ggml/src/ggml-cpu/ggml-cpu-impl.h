...
// MSVC compatibility: /arch:AVX2 defines _M_AVX/_M_AVX2 but NOT the GCC/Clang
// __AVX__/__AVX2__ macros that the rest of the codebase checks for. Without
// this mapping, all SIMD paths (vec_dot, im2col, repack, etc.) are silently
// disabled and the GEMM falls back to scalar code (~10x slower).
#if defined(_MSC_VER) && !defined(__clang__)
#if defined(_M_AVX512)

...
#   WINEFOX_BUILD_CORE_DLL - build winefox_core as a SHARED DLL with C ABI exports (for world exe)
#   WINEFOX_BUILD_WORLD    - build the 3D World frontend (Vulkan + SDL3, Phase 4, Windows only)
...
#   WINEFOX_BUILD_VOICE_TEST - build the voice-test benchmark sandbox (Phase 2)
...
option(WINEFOX_BUILD_CORE_DLL "Build winefox_core as SHARED DLL with C ABI (for world exe linking)" OFF)
option(WINEFOX_BUILD_WORLD    "Build the 3D World frontend (Vulkan + SDL3, Windows only)" OFF)
...
# Path to the pre-built winefox_core.dll import lib (set when building world exe).
set(WINEFOX_CORE_DLL_DIR "" CACHE PATH "Directory containing winefox_core.lib + winefox_core.dll (for WINEFOX_BUILD_WORLD)")
...
if(WINEFOX_MINIMAL)
    ...
    set(WINEFOX_BUILD_WORLD   OFF CACHE BOOL "" FORCE)
...
if(WINEFOX_BUILD_WORLD)
    add_compile_definitions(WINEFOX_BUILD_WORLD)
endif()
...
message(STATUS "  WINEFOX_BUILD_CORE_DLL = ${WINEFOX_BUILD_CORE_DLL}")
message(STATUS "  WINEFOX_BUILD_WORLD    = ${WINEFOX_BUILD_WORLD}")
...
message(STATUS "  WINEFOX_CORE_DLL_DIR   = ${WINEFOX_CORE_DLL_DIR}")
